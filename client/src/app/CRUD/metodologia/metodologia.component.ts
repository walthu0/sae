...
export class MetodologiaComponent implements OnInit {
   ...
   busy: Promise<any>;
   entidades: Metodologia[];
   entidadSeleccionada: Metodologia;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: MetodologiaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Metodologia): boolean {
      return true;
   }
   ...
   crearEntidad(): Metodologia {
      const nuevoMetodologia = new Metodologia();
      nuevoMetodologia.id = 0;
      return nuevoMetodologia;
   }

   add(entidadNueva: Metodologia): void {
   ...
   update(entidadParaActualizar: Metodologia): void {
   ...
   delete(entidadParaBorrar: Metodologia): void {
   ...
   onSelect(entidadActual: Metodologia): void {
