...
@Component({
   selector: 'app-plansemanaactividades',
   templateUrl: './plansemanaactividades.component.html',
   styleUrls: ['./plansemanaactividades.component.scss']
})

export class PlanSemanaActividadesComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaActividades[];
   entidadSeleccionada: PlanSemanaActividades;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaActividadesService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaActividades): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaActividades {
      const nuevoPlanSemanaActividades = new PlanSemanaActividades();
      nuevoPlanSemanaActividades.id = 0;
      return nuevoPlanSemanaActividades;
   }

   add(entidadNueva: PlanSemanaActividades): void {
   ...
   update(entidadParaActualizar: PlanSemanaActividades): void {
   ...
   delete(entidadParaBorrar: PlanSemanaActividades): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaActividades[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaActividades): void {
