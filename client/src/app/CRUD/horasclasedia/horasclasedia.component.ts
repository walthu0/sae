...
@Component({
   selector: 'app-horasclasedia',
   templateUrl: './horasclasedia.component.html',
   styleUrls: ['./horasclasedia.component.scss']
})

export class HorasClaseDiaComponent implements OnInit {

   busy: Promise<any>;
   entidades: HorasClaseDia[];
   entidadSeleccionada: HorasClaseDia;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: HorasClaseDiaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: HorasClaseDia): boolean {
      return true;
   }
   ...
   crearEntidad(): HorasClaseDia {
      const nuevoHorasClaseDia = new HorasClaseDia();
      nuevoHorasClaseDia.id = 0;
      return nuevoHorasClaseDia;
   }

   add(entidadNueva: HorasClaseDia): void {
   ...
   update(entidadParaActualizar: HorasClaseDia): void {
   ...
   delete(entidadParaBorrar: HorasClaseDia): void {
   ...
   refresh(): void {
      ...
      this.entidades = HorasClaseDia[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: HorasClaseDia): void {
