...
@Component({
   selector: 'app-destinorecursosestudiante',
   templateUrl: './destinorecursosestudiante.component.html',
   styleUrls: ['./destinorecursosestudiante.component.scss']
})

export class DestinoRecursosEstudianteComponent implements OnInit {

   busy: Promise<any>;
   entidades: DestinoRecursosEstudiante[];
   entidadSeleccionada: DestinoRecursosEstudiante;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: DestinoRecursosEstudianteService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: DestinoRecursosEstudiante): boolean {
      return true;
   }
   ...
   crearEntidad(): DestinoRecursosEstudiante {
      const nuevoDestinoRecursosEstudiante = new DestinoRecursosEstudiante();
      nuevoDestinoRecursosEstudiante.id = 0;
      return nuevoDestinoRecursosEstudiante;
   }

   add(entidadNueva: DestinoRecursosEstudiante): void {
   ...
   update(entidadParaActualizar: DestinoRecursosEstudiante): void {
   ...
   delete(entidadParaBorrar: DestinoRecursosEstudiante): void {
   ...
   refresh(): void {
      ...
      this.entidades = DestinoRecursosEstudiante[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: DestinoRecursosEstudiante): void {
