...
@Component({
   selector: 'app-asignaturaprerrequisito',
   templateUrl: './asignaturaprerrequisito.component.html',
   styleUrls: ['./asignaturaprerrequisito.component.scss']
})

export class AsignaturaPrerrequisitoComponent implements OnInit {

   busy: Promise<any>;
   entidades: AsignaturaPrerrequisito[];
   entidadSeleccionada: AsignaturaPrerrequisito;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: AsignaturaPrerrequisitoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: AsignaturaPrerrequisito): boolean {
      return true;
   }
   ...
   crearEntidad(): AsignaturaPrerrequisito {
      const nuevoAsignaturaPrerrequisito = new AsignaturaPrerrequisito();
      nuevoAsignaturaPrerrequisito.id = 0;
      return nuevoAsignaturaPrerrequisito;
   }

   add(entidadNueva: AsignaturaPrerrequisito): void {
   ...
   update(entidadParaActualizar: AsignaturaPrerrequisito): void {
   ...
   delete(entidadParaBorrar: AsignaturaPrerrequisito): void {
   ...
   refresh(): void {
      ...
      this.entidades = AsignaturaPrerrequisito[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: AsignaturaPrerrequisito): void {
