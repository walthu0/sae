...
@Component({
   selector: 'app-plansemanaejetransversal',
   templateUrl: './plansemanaejetransversal.component.html',
   styleUrls: ['./plansemanaejetransversal.component.scss']
})

export class PlanSemanaEjeTransversalComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaEjeTransversal[];
   entidadSeleccionada: PlanSemanaEjeTransversal;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaEjeTransversalService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaEjeTransversal): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaEjeTransversal {
      const nuevoPlanSemanaEjeTransversal = new PlanSemanaEjeTransversal();
      nuevoPlanSemanaEjeTransversal.id = 0;
      return nuevoPlanSemanaEjeTransversal;
   }

   add(entidadNueva: PlanSemanaEjeTransversal): void {
   ...
   update(entidadParaActualizar: PlanSemanaEjeTransversal): void {
   ...
   delete(entidadParaBorrar: PlanSemanaEjeTransversal): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaEjeTransversal[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaEjeTransversal): void {
