...
@Component({
   selector: 'app-silabounidades',
   templateUrl: './silabounidades.component.html',
   styleUrls: ['./silabounidades.component.scss']
})

export class SilaboUnidadesComponent implements OnInit {

   busy: Promise<any>;
   entidades: SilaboUnidades[];
   entidadSeleccionada: SilaboUnidades;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: SilaboUnidadesService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: SilaboUnidades): boolean {
      return true;
   }
   ...
   crearEntidad(): SilaboUnidades {
      const nuevoSilaboUnidades = new SilaboUnidades();
      nuevoSilaboUnidades.id = 0;
      return nuevoSilaboUnidades;
   }

   add(entidadNueva: SilaboUnidades): void {
   ...
   update(entidadParaActualizar: SilaboUnidades): void {
   ...
   delete(entidadParaBorrar: SilaboUnidades): void {
   ...
   refresh(): void {
      ...
      this.entidades = SilaboUnidades[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: SilaboUnidades): void {
