...
@Component({
   selector: 'app-unidadorganizacion',
   templateUrl: './unidadorganizacion.component.html',
   styleUrls: ['./unidadorganizacion.component.scss']
})

export class UnidadOrganizacionComponent implements OnInit {

   busy: Promise<any>;
   entidades: UnidadOrganizacion[];
   entidadSeleccionada: UnidadOrganizacion;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: UnidadOrganizacionService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: UnidadOrganizacion): boolean {
      return true;
   }
   ...
   crearEntidad(): UnidadOrganizacion {
      const nuevoUnidadOrganizacion = new UnidadOrganizacion();
      nuevoUnidadOrganizacion.id = 0;
      return nuevoUnidadOrganizacion;
   }

   add(entidadNueva: UnidadOrganizacion): void {
   ...
   update(entidadParaActualizar: UnidadOrganizacion): void {
   ...
   delete(entidadParaBorrar: UnidadOrganizacion): void {
   ...
   refresh(): void {
      ...
      this.entidades = UnidadOrganizacion[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: UnidadOrganizacion): void {
