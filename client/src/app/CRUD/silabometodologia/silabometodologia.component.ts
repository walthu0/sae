...
@Component({
   selector: 'app-silabometodologia',
   templateUrl: './silabometodologia.component.html',
   styleUrls: ['./silabometodologia.component.scss']
})

export class SilaboMetodologiaComponent implements OnInit {

   busy: Promise<any>;
   entidades: SilaboMetodologia[];
   entidadSeleccionada: SilaboMetodologia;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: SilaboMetodologiaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: SilaboMetodologia): boolean {
      return true;
   }
   ...
   crearEntidad(): SilaboMetodologia {
      const nuevoSilaboMetodologia = new SilaboMetodologia();
      nuevoSilaboMetodologia.id = 0;
      return nuevoSilaboMetodologia;
   }

   add(entidadNueva: SilaboMetodologia): void {
   ...
   update(entidadParaActualizar: SilaboMetodologia): void {
   ...
   delete(entidadParaBorrar: SilaboMetodologia): void {
   ...
   refresh(): void {
      ...
      this.entidades = SilaboMetodologia[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: SilaboMetodologia): void {
