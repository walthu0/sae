...
@Component({
   selector: 'app-plansemanasubtema',
   templateUrl: './plansemanasubtema.component.html',
   styleUrls: ['./plansemanasubtema.component.scss']
})

export class PlanSemanaSubTemaComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaSubTema[];
   entidadSeleccionada: PlanSemanaSubTema;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaSubTemaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaSubTema): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaSubTema {
      const nuevoPlanSemanaSubTema = new PlanSemanaSubTema();
      nuevoPlanSemanaSubTema.id = 0;
      return nuevoPlanSemanaSubTema;
   }

   add(entidadNueva: PlanSemanaSubTema): void {
   ...
   update(entidadParaActualizar: PlanSemanaSubTema): void {
   ...
   delete(entidadParaBorrar: PlanSemanaSubTema): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaSubTema[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaSubTema): void {
