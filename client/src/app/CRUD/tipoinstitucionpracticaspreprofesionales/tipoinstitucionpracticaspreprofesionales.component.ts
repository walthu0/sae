...
@Component({
   selector: 'app-tipoinstitucionpracticaspreprofesionales',
   templateUrl: './tipoinstitucionpracticaspreprofesionales.component.html',
   styleUrls: ['./tipoinstitucionpracticaspreprofesionales.component.scss']
})

export class TipoInstitucionPracticasPreprofesionalesComponent implements OnInit {

   busy: Promise<any>;
   entidades: TipoInstitucionPracticasPreprofesionales[];
   entidadSeleccionada: TipoInstitucionPracticasPreprofesionales;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: TipoInstitucionPracticasPreprofesionalesService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: TipoInstitucionPracticasPreprofesionales): boolean {
      return true;
   }
   ...
   crearEntidad(): TipoInstitucionPracticasPreprofesionales {
      const nuevoTipoInstitucionPracticasPreprofesionales = new TipoInstitucionPracticasPreprofesionales();
      nuevoTipoInstitucionPracticasPreprofesionales.id = 0;
      return nuevoTipoInstitucionPracticasPreprofesionales;
   }

   add(entidadNueva: TipoInstitucionPracticasPreprofesionales): void {
   ...
   update(entidadParaActualizar: TipoInstitucionPracticasPreprofesionales): void {
   ...
   delete(entidadParaBorrar: TipoInstitucionPracticasPreprofesionales): void {
   ...
   refresh(): void {
      ...
      this.entidades = TipoInstitucionPracticasPreprofesionales[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: TipoInstitucionPracticasPreprofesionales): void {
