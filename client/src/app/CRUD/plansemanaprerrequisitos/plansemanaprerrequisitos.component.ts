...
@Component({
   selector: 'app-plansemanaprerrequisitos',
   templateUrl: './plansemanaprerrequisitos.component.html',
   styleUrls: ['./plansemanaprerrequisitos.component.scss']
})

export class PlanSemanaPrerrequisitosComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaPrerrequisitos[];
   entidadSeleccionada: PlanSemanaPrerrequisitos;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaPrerrequisitosService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaPrerrequisitos): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaPrerrequisitos {
      const nuevoPlanSemanaPrerrequisitos = new PlanSemanaPrerrequisitos();
      nuevoPlanSemanaPrerrequisitos.id = 0;
      return nuevoPlanSemanaPrerrequisitos;
   }

   add(entidadNueva: PlanSemanaPrerrequisitos): void {
   ...
   update(entidadParaActualizar: PlanSemanaPrerrequisitos): void {
   ...
   delete(entidadParaBorrar: PlanSemanaPrerrequisitos): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaPrerrequisitos[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaPrerrequisitos): void {
