...
@Component({
   selector: 'app-modalidadcarrera',
   templateUrl: './modalidadcarrera.component.html',
   styleUrls: ['./modalidadcarrera.component.scss']
})

export class ModalidadCarreraComponent implements OnInit {

   busy: Promise<any>;
   entidades: ModalidadCarrera[];
   entidadSeleccionada: ModalidadCarrera;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ModalidadCarreraService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: ModalidadCarrera): boolean {
      return true;
   }
   ...
   crearEntidad(): ModalidadCarrera {
      const nuevoModalidadCarrera = new ModalidadCarrera();
      nuevoModalidadCarrera.id = 0;
      return nuevoModalidadCarrera;
   }

   add(entidadNueva: ModalidadCarrera): void {
   ...
   update(entidadParaActualizar: ModalidadCarrera): void {
   ...
   delete(entidadParaBorrar: ModalidadCarrera): void {
   ...
   refresh(): void {
      ...
      this.entidades = ModalidadCarrera[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: ModalidadCarrera): void {
