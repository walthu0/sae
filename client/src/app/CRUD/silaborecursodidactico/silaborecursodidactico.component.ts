...
@Component({
   selector: 'app-silaborecursodidactico',
   templateUrl: './silaborecursodidactico.component.html',
   styleUrls: ['./silaborecursodidactico.component.scss']
})

export class SilaboRecursoDidacticoComponent implements OnInit {

   busy: Promise<any>;
   entidades: SilaboRecursoDidactico[];
   entidadSeleccionada: SilaboRecursoDidactico;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: SilaboRecursoDidacticoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: SilaboRecursoDidactico): boolean {
      return true;
   }
   ...
   crearEntidad(): SilaboRecursoDidactico {
      const nuevoSilaboRecursoDidactico = new SilaboRecursoDidactico();
      nuevoSilaboRecursoDidactico.id = 0;
      return nuevoSilaboRecursoDidactico;
   }

   add(entidadNueva: SilaboRecursoDidactico): void {
   ...
   update(entidadParaActualizar: SilaboRecursoDidactico): void {
   ...
   delete(entidadParaBorrar: SilaboRecursoDidactico): void {
   ...
   refresh(): void {
      ...
      this.entidades = SilaboRecursoDidactico[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: SilaboRecursoDidactico): void {
