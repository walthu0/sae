...
@Component({
   selector: 'app-silaboresultados',
   templateUrl: './silaboresultados.component.html',
   styleUrls: ['./silaboresultados.component.scss']
})

export class SilaboResultadosComponent implements OnInit {

   busy: Promise<any>;
   entidades: SilaboResultados[];
   entidadSeleccionada: SilaboResultados;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: SilaboResultadosService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: SilaboResultados): boolean {
      return true;
   }
   ...
   crearEntidad(): SilaboResultados {
      const nuevoSilaboResultados = new SilaboResultados();
      nuevoSilaboResultados.id = 0;
      return nuevoSilaboResultados;
   }

   add(entidadNueva: SilaboResultados): void {
   ...
   update(entidadParaActualizar: SilaboResultados): void {
   ...
   delete(entidadParaBorrar: SilaboResultados): void {
   ...
   refresh(): void {
      ...
      this.entidades = SilaboResultados[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: SilaboResultados): void {
