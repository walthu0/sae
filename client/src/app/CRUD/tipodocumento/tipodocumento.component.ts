...
export class TipoDocumentoComponent implements OnInit {
   ...
   entidadSeleccionada: TipoDocumento;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: TipoDocumentoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: TipoDocumento): boolean {
      return true;
   }
   ...
   crearEntidad(): TipoDocumento {
      const nuevoTipoDocumento = new TipoDocumento();
      nuevoTipoDocumento.id = 0;
      return nuevoTipoDocumento;
   }

   add(entidadNueva: TipoDocumento): void {
   ...
   update(entidadParaActualizar: TipoDocumento): void {
   ...
   delete(entidadParaBorrar: TipoDocumento): void {
   ...
   refresh(): void {
      ...
      this.entidades = TipoDocumento[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: TipoDocumento): void {
