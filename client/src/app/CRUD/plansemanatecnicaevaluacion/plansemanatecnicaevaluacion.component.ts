...
@Component({
   selector: 'app-plansemanatecnicaevaluacion',
   templateUrl: './plansemanatecnicaevaluacion.component.html',
   styleUrls: ['./plansemanatecnicaevaluacion.component.scss']
})

export class PlanSemanaTecnicaEvaluacionComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaTecnicaEvaluacion[];
   entidadSeleccionada: PlanSemanaTecnicaEvaluacion;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaTecnicaEvaluacionService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaTecnicaEvaluacion): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaTecnicaEvaluacion {
      const nuevoPlanSemanaTecnicaEvaluacion = new PlanSemanaTecnicaEvaluacion();
      nuevoPlanSemanaTecnicaEvaluacion.id = 0;
      return nuevoPlanSemanaTecnicaEvaluacion;
   }

   add(entidadNueva: PlanSemanaTecnicaEvaluacion): void {
   ...
   update(entidadParaActualizar: PlanSemanaTecnicaEvaluacion): void {
   ...
   delete(entidadParaBorrar: PlanSemanaTecnicaEvaluacion): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaTecnicaEvaluacion[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaTecnicaEvaluacion): void {
