...
@Component({
   selector: 'app-relacionperfilresultado',
   templateUrl: './relacionperfilresultado.component.html',
   styleUrls: ['./relacionperfilresultado.component.scss']
})

export class RelacionPerfilResultadoComponent implements OnInit {

   busy: Promise<any>;
   entidades: RelacionPerfilResultado[];
   entidadSeleccionada: RelacionPerfilResultado;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: RelacionPerfilResultadoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: RelacionPerfilResultado): boolean {
      return true;
   }
   ...
   crearEntidad(): RelacionPerfilResultado {
      const nuevoRelacionPerfilResultado = new RelacionPerfilResultado();
      nuevoRelacionPerfilResultado.id = 0;
      return nuevoRelacionPerfilResultado;
   }

   add(entidadNueva: RelacionPerfilResultado): void {
   ...
   update(entidadParaActualizar: RelacionPerfilResultado): void {
   ...
   delete(entidadParaBorrar: RelacionPerfilResultado): void {
   ...
   refresh(): void {
      ...
      this.entidades = RelacionPerfilResultado[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: RelacionPerfilResultado): void {
