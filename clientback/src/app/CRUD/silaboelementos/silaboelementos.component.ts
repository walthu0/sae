...
@Component({
   selector: 'app-silaboelementos',
   templateUrl: './silaboelementos.component.html',
   styleUrls: ['./silaboelementos.component.scss']
})

export class SilaboElementosComponent implements OnInit {

   busy: Promise<any>;
   entidades: SilaboElementos[];
   entidadSeleccionada: SilaboElementos;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: SilaboElementosService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: SilaboElementos): boolean {
      return true;
   }
   ...
   crearEntidad(): SilaboElementos {
      const nuevoSilaboElementos = new SilaboElementos();
      nuevoSilaboElementos.id = 0;
      return nuevoSilaboElementos;
   }

   add(entidadNueva: SilaboElementos): void {
   ...
   update(entidadParaActualizar: SilaboElementos): void {
   ...
   delete(entidadParaBorrar: SilaboElementos): void {
   ...
   refresh(): void {
      ...
      this.entidades = SilaboElementos[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: SilaboElementos): void {
