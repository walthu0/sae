...
@Component({
   selector: 'app-recursosdidacticos',
   templateUrl: './recursosdidacticos.component.html',
   styleUrls: ['./recursosdidacticos.component.scss']
})

export class RecursosDidacticosComponent implements OnInit {

   busy: Promise<any>;
   entidades: RecursosDidacticos[];
   entidadSeleccionada: RecursosDidacticos;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: RecursosDidacticosService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: RecursosDidacticos): boolean {
      return true;
   }
   ...
   crearEntidad(): RecursosDidacticos {
      const nuevoRecursosDidacticos = new RecursosDidacticos();
      nuevoRecursosDidacticos.id = 0;
      return nuevoRecursosDidacticos;
   }

   add(entidadNueva: RecursosDidacticos): void {
   ...
   update(entidadParaActualizar: RecursosDidacticos): void {
   ...
   delete(entidadParaBorrar: RecursosDidacticos): void {
   ...
   refresh(): void {
      ...
      this.entidades = RecursosDidacticos[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: RecursosDidacticos): void {
