...
@Component({
   selector: 'app-sectoreconomicopracticaspreprofesionales',
   templateUrl: './sectoreconomicopracticaspreprofesionales.component.html',
   styleUrls: ['./sectoreconomicopracticaspreprofesionales.component.scss']
})

export class SectorEconomicoPracticasPreprofesionalesComponent implements OnInit {

   busy: Promise<any>;
   entidades: SectorEconomicoPracticasPreprofesionales[];
   entidadSeleccionada: SectorEconomicoPracticasPreprofesionales;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: SectorEconomicoPracticasPreprofesionalesService, private modalService: NgbModal) {
   ...
   getAll(): void {
      ...
      .catch(error => {
         this.toastr.warning('Se produjo un error', 'Consulta');
      });
   }
   ...
   isValid(entidadPorEvaluar: SectorEconomicoPracticasPreprofesionales): boolean {
      return true;
   }
   ...
   crearEntidad(): SectorEconomicoPracticasPreprofesionales {
      const nuevoSectorEconomicoPracticasPreprofesionales = new SectorEconomicoPracticasPreprofesionales();
      nuevoSectorEconomicoPracticasPreprofesionales.id = 0;
      return nuevoSectorEconomicoPracticasPreprofesionales;
   }

   add(entidadNueva: SectorEconomicoPracticasPreprofesionales): void {
   ...
   update(entidadParaActualizar: SectorEconomicoPracticasPreprofesionales): void {
   ...
   delete(entidadParaBorrar: SectorEconomicoPracticasPreprofesionales): void {
   ...
   refresh(): void {
      ...
      this.entidades = SectorEconomicoPracticasPreprofesionales[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: SectorEconomicoPracticasPreprofesionales): void {
