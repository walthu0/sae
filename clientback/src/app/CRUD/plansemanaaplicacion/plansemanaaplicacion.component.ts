...
@Component({
   selector: 'app-plansemanaaplicacion',
   templateUrl: './plansemanaaplicacion.component.html',
   styleUrls: ['./plansemanaaplicacion.component.scss']
})

export class PlanSemanaAplicacionComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaAplicacion[];
   entidadSeleccionada: PlanSemanaAplicacion;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaAplicacionService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaAplicacion): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaAplicacion {
      const nuevoPlanSemanaAplicacion = new PlanSemanaAplicacion();
      nuevoPlanSemanaAplicacion.id = 0;
      return nuevoPlanSemanaAplicacion;
   }

   add(entidadNueva: PlanSemanaAplicacion): void {
   ...
   update(entidadParaActualizar: PlanSemanaAplicacion): void {
   ...
   delete(entidadParaBorrar: PlanSemanaAplicacion): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaAplicacion[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaAplicacion): void {
