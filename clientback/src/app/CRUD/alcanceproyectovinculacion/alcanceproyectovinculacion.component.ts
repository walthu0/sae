...
@Component({
   selector: 'app-alcanceproyectovinculacion',
   templateUrl: './alcanceproyectovinculacion.component.html',
   styleUrls: ['./alcanceproyectovinculacion.component.scss']
})

export class AlcanceProyectoVinculacionComponent implements OnInit {

   busy: Promise<any>;
   entidades: AlcanceProyectoVinculacion[];
   entidadSeleccionada: AlcanceProyectoVinculacion;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: AlcanceProyectoVinculacionService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: AlcanceProyectoVinculacion): boolean {
      return true;
   }
   ...
   crearEntidad(): AlcanceProyectoVinculacion {
      const nuevoAlcanceProyectoVinculacion = new AlcanceProyectoVinculacion();
      nuevoAlcanceProyectoVinculacion.id = 0;
      return nuevoAlcanceProyectoVinculacion;
   }

   add(entidadNueva: AlcanceProyectoVinculacion): void {
   ...
   update(entidadParaActualizar: AlcanceProyectoVinculacion): void {
   ...
   delete(entidadParaBorrar: AlcanceProyectoVinculacion): void {
   ...
   refresh(): void {
      ...
      this.entidades = AlcanceProyectoVinculacion[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: AlcanceProyectoVinculacion): void {
