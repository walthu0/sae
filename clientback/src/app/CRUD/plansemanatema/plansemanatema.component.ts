...
@Component({
   selector: 'app-plansemanatema',
   templateUrl: './plansemanatema.component.html',
   styleUrls: ['./plansemanatema.component.scss']
})

export class PlanSemanaTemaComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaTema[];
   entidadSeleccionada: PlanSemanaTema;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaTemaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaTema): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaTema {
      const nuevoPlanSemanaTema = new PlanSemanaTema();
      nuevoPlanSemanaTema.id = 0;
      return nuevoPlanSemanaTema;
   }

   add(entidadNueva: PlanSemanaTema): void {
   ...
   update(entidadParaActualizar: PlanSemanaTema): void {
   ...
   delete(entidadParaBorrar: PlanSemanaTema): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaTema[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaTema): void {
