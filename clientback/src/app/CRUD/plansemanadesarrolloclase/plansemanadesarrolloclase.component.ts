...
@Component({
   selector: 'app-plansemanadesarrolloclase',
   templateUrl: './plansemanadesarrolloclase.component.html',
   styleUrls: ['./plansemanadesarrolloclase.component.scss']
})

export class PlanSemanaDesarrolloClaseComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaDesarrolloClase[];
   entidadSeleccionada: PlanSemanaDesarrolloClase;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaDesarrolloClaseService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaDesarrolloClase): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaDesarrolloClase {
      const nuevoPlanSemanaDesarrolloClase = new PlanSemanaDesarrolloClase();
      nuevoPlanSemanaDesarrolloClase.id = 0;
      return nuevoPlanSemanaDesarrolloClase;
   }

   add(entidadNueva: PlanSemanaDesarrolloClase): void {
   ...
   update(entidadParaActualizar: PlanSemanaDesarrolloClase): void {
   ...
   delete(entidadParaBorrar: PlanSemanaDesarrolloClase): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaDesarrolloClase[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaDesarrolloClase): void {
