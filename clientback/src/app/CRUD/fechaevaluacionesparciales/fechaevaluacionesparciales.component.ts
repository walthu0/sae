...
@Component({
   selector: 'app-fechaevaluacionesparciales',
   templateUrl: './fechaevaluacionesparciales.component.html',
   styleUrls: ['./fechaevaluacionesparciales.component.scss']
})

export class fechaEvaluacionesParcialesComponent implements OnInit {

   busy: Promise<any>;
   entidades: fechaEvaluacionesParciales[];
   entidadSeleccionada: fechaEvaluacionesParciales;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: fechaEvaluacionesParcialesService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: fechaEvaluacionesParciales): boolean {
      return true;
   }
   ...
   crearEntidad(): fechaEvaluacionesParciales {
      const nuevofechaEvaluacionesParciales = new fechaEvaluacionesParciales();
      nuevofechaEvaluacionesParciales.id = 0;
      return nuevofechaEvaluacionesParciales;
   }

   add(entidadNueva: fechaEvaluacionesParciales): void {
   ...
   update(entidadParaActualizar: fechaEvaluacionesParciales): void {
   ...
   delete(entidadParaBorrar: fechaEvaluacionesParciales): void {
   ...
   refresh(): void {
      ...
      this.entidades = fechaEvaluacionesParciales[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: fechaEvaluacionesParciales): void {
