...
@Component({
   selector: 'app-plansemanarecursodidactico',
   templateUrl: './plansemanarecursodidactico.component.html',
   styleUrls: ['./plansemanarecursodidactico.component.scss']
})

export class PlanSemanaRecursoDidacticoComponent implements OnInit {

   busy: Promise<any>;
   entidades: PlanSemanaRecursoDidactico[];
   entidadSeleccionada: PlanSemanaRecursoDidactico;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: PlanSemanaRecursoDidacticoService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: PlanSemanaRecursoDidactico): boolean {
      return true;
   }
   ...
   crearEntidad(): PlanSemanaRecursoDidactico {
      const nuevoPlanSemanaRecursoDidactico = new PlanSemanaRecursoDidactico();
      nuevoPlanSemanaRecursoDidactico.id = 0;
      return nuevoPlanSemanaRecursoDidactico;
   }

   add(entidadNueva: PlanSemanaRecursoDidactico): void {
   ...
   update(entidadParaActualizar: PlanSemanaRecursoDidactico): void {
   ...
   delete(entidadParaBorrar: PlanSemanaRecursoDidactico): void {
   ...
   refresh(): void {
      ...
      this.entidades = PlanSemanaRecursoDidactico[0];
      this.entidadSeleccionada = this.crearEntidad();
   }
   ...
   onSelect(entidadActual: PlanSemanaRecursoDidactico): void {
